...
ALLOWED_EXTENSIONS = set(
    ['png', 'PNG', 'jpg', 'JPG', 'jpeg', 'JPEG', 'gif', 'GIF'])  # models support png and gif as well
     ...
     with app.app_context():
        ...
        if file and allowed_file(file):
            filename = secure_filename(
                file)  # used to secure a filename before storing it directly on the filesystem
            ...
            return render(request,'results.html', result=model_results, filename=filename)
